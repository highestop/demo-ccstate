...
export const noGetSignal = createRule({
  ...
  meta: {
    type: 'problem',
    docs: {
      description: 'AbortSignal should not be get by state, use signal parameter instead.',
      recommended: true,
      requiresTypeChecking: true,
    },
    schema: [],
    messages: {
      noGetSignal: 'AbortSignal should not be get by state, use signal parameter instead.',
    },
  },
  create(context) {
